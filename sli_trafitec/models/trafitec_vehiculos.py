...
class TrafitecVehiculos(models.Model):
	...
	nombre_fisio = fields.Char(
		string="Verificaciones fisio-mecanicas", 
		compute="change_name_vehicle_documents"
	)
	...
	def change_name_vehicle_documents(self):
		if self.license_plate :
			...
			self.nombre_fisio = "Verificaciones fisio-mecanicas.png"
	...
	def create(self, vals):
		...
		return super(TrafitecVehiculos, self).create(vals)
	...
	def write(self, vals):
		...
		return super(TrafitecVehiculos, self).write(vals)
