	...
	def Abonar(self, total):
		...
		for f in self.facturas_id:
			...
			valor = {'move_id': move_id.id, 'account_id': f.factura_id.account_id.id, 'partner_id': self.persona_id.id,
					...
					'ref': '' + str(f.factura_id.number000), 'name': '' + str(f.factura_id.number000), 'credit': total,
			...
			valor = {'move_id': move_id.id, 'account_id': self.diario_id.default_debit_account_id.id,
					...
					'invoice_id': f.factura_id.id, 'ref': '' + str(f.factura_id.number000),
					'name': '' + str(f.factura_id.number000), 'credit': 0, 'debit': total, 'payment_id': pago_id.id}
			print("*****Valor2:")
			print(valor)
