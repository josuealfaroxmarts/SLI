...
class trafitec_asociados(models.Model):
	...
	vat_info = fields.Binary(string='NIF')
	...
	comprobante_domicilio = fields.Binary(string="Comprobante domicilio")



	numero_medicina = fields.Char(string='Número medicina')
	name_medicina_ad = fields.Char(compute="changename")
	numero_medicina_ad = fields.Binary(string="Adjuntar número de medicina")
	...
	domicilio_moral = fields.Binary(string="Comprobante de domilicio")
...
class trafitec_vehiculos(models.Model):
	...
	numero_motor = fields.Char(string='Número Motor')
	tipo_vehiculo = fields.Selection([("tractocamion", "Tractocamion"), ("remolque", "Remolque"), ("dolly", "Dolly")],string='Tipo de vehículo')
	nombre_factura_rendamiento = fields.Char(string='Copia de factura o contrato de arrendamiento', compute='change_name_vehicle_documents')
	factura_rendamiento = fields.Binary(string='Copia de factura o contrato de arrendamiento')
	...
	ambientales = fields.Char(string='Verificaciones ambientales')
	ambientales_fecha = fields.Char(string='Fecha de vigencia de poliza')
	...
	def change_name_vehicle_documents(self):
		if self.license_plate :
			...
			self.nombre_factura_rendamiento = "Copia de factura o contrato de arrendamiento (" + self.license_plate + ").png"
