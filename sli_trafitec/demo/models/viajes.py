...
class trafitec_viajes(models.Model):
    ...
    referencia_cliente = fields.Char(string="Referencia Viaje Cliente", readonly=True)
    referencia_fletex = fields.Char(string="Referencia Viaje Cliente", readonly=True)
    referencia_asociado = fields.Char(string="Referencia Viaje Asociado", readonly=True)
    ...
    def _compute_info(self):
        ...
        try:
            ...
            info += "CP: " + (cp.number or "") + " " + (cp.reference or "") + " " + (cp.date or "") + " " + (self.traduce_account_invoice_state(cp.state) or "") + "  "
            info += "F:  " + (f.number or "") + " " + (f.date or "") + " " + (self.traduce_account_invoice_state(f.state) or "") + "  "
        except:
