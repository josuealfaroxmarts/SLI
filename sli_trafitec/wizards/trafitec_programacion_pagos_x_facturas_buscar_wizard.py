...
class TrafitecProgramacionPagosXFacturasBuscarWizard(models.TransientModel):
	_name = "trafitec.programacion.pagos.x.facturas.buscar.wizard"
	_description="Programacion Pagos X Facturas Buscar Wizard"
