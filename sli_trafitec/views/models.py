...
class trafitec_respartner(models.Model):
	...
	def change_limits(self):
		self.limite_credito_fletex = self.limite_credito
...
class trafitec_asociados(models.Model):
	...
	ext_iden_fisica = fields.Char(string='extension archivo representante', default="pdf")
...
class trafitec_vehiculos(models.Model):
	...
	ext_circulacion = fields.Char(string='Extension archivo ciculacion', default="pdf")
	...
	ext_poliza_seguro = fields.Char(string='extension archivo Poliza del seguro', default="pdf")
	...
	def change_name_vehicle_documents(self):
		if self.license_plate :
			if self.ext_circulacion == False:
				self.ext_circulacion = "pdf"
			if self.ext_poliza_seguro == False:
				self.ext_poliza_seguro = "pdf"
