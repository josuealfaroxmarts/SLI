...
class SyncDataFletex(models.Model):
    ...
    def sync_data(self):
        ...
        # If the request brings users, user manager is called
    ...
    def locations_manager(self, location, headers):
        ...
        if len(record) > 0:
            ...
            _logger.debug('CREADASSSSSSSSSSSSSSSS!!!!!!!!!!!!!!!!!!1')
            ...
            for record in records:
                ...
                if record['estado_viaje'] == 'finalizado' :
                    ...
                    vals = {
                        ...
                        'evidencia_file': shipment['evicencefirst'],
                    ...
                    vals = {
                        'linea_id': shipment['shipment_id'],
                        'evidencia_file': shipment['evicenceold'],
                        'image_filename': "Evidencia de viaje {}".format(record['id']),
                        'name': "Evidencia de viaje"
                    }
                    self.env['trafitec.viajes.enviencias'].create(vals)
